...
alpha   = 1e-3;       % scaling constant - from literature (set to larger value for wider distribution spread)
...
for i=1:2*K+1
    Xx{i}     = dynfun (X{i},A,B,theta,Z,knots,basis_type) + G*q{i}; % sigma state propagation
